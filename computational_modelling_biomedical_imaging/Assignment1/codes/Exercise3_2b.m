...
[parameter_hat2,RESNORM2,EXITFLAG2,OUTPUT2]=fminunc('ZeppelinStickTortuositySSD',newstartx,h, ...
                                                     meas,bvals,grad_dirs);
                                                                                             

% average and standard deviation for predicted signal
[RESNORM_check2, S_pred2] = ZeppelinStickTortuositySSD(parameter_hat2, meas, bvals, grad_dirs);
...
for i=1:iters_for_min
    ...
    % Now run the fitting
    [parameter_hat,RESNORM,EXITFLAG,OUTPUT]=fminunc('ZeppelinStickTortuositySSD',...
