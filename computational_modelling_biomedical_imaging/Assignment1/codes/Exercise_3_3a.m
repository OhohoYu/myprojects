...
[parameter_hat2,RESNORM2,EXITFLAG2,OUTPUT2]=fminunc('BallStickSSD_IC',newstartx,h, ...
                                                     meas,bvals,grad_dirs);
                                                                                             

% average and standard deviation for predicted signal
[RESNORM_check2, S_pred2, AIC, BIC] = BallStickSSD_IC(parameter_hat2, meas, bvals, grad_dirs);
AIC
BIC
