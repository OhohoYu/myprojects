...
if(!(taxonomist.method %in% c("all","filtered - not status","filtered - status", 
			   ...
			   "filtered - includes hybrids - status - basionym dated",
                           "all basionyms", "basionyms filtered - not status", 
...
if(taxonomist.method == "filtered - status - basionym dated") {
        #
        # Method applies all filters 
        #
        tx.tax.stat <- TRUE
        ...
        #
        # Modify the ID string
        identifier <- paste(identifier,"_tax_filt_basio_dated",sep="")	
        #
}
#
if(taxonomist.method == "filtered - includes hybrids - status - basionym dated") {
        #
        # Method applies all filters 
        #
        tx.tax.stat <- TRUE
        ...
        #
        # Modify the ID string
        identifier <- paste(identifier,"_tax_filt_hyb_inc_basio_dated",sep="")	
        #
}
#
