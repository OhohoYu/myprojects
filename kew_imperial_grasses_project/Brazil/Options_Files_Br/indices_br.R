...
#
id.ind <- c(1,1) # angiosperms_species_id & id
#
#
# Year column - index of the column where the year of publication is stored in 
# the species data
#
yr.ind <- 36   # ipni_publication_year
#
#
# Primary Authors column - index of the column containing the primary authors in 
# the specis data
#
auth.ind <- 34 # ipni_publishing_author
# could also be auth.ind <- 17 "scientificNameAuthorship" 
#
#
